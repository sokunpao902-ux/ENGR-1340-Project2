...
Some of its features include: 
    ...
    - Courses: Video tutorials as well as live tutoring to help students learn skills they need.
    
    - Success tools: Tools that allows companies to filter through data to find the best possible candidate. For students, it allows them to filter through data to find companies that are likely to hire them.
